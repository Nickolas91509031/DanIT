...
1.Щоб створити функцію нам треба її оголосити. Функції JavaScript можна оголосити трьома способами: через декларативне оголошення, функціональне вираження або за допомогою стрілок. Декларативне оголошення: спочатку ми пишемо function — це ключове слово (keyword), яке дає зрозуміти комп'ютеру, що далі буде оголошення функції. Потім — назву функції і список її параметрів в дужках (розділені комою). Якщо параметрів немає, ми залишаємо пусті дужки. 
